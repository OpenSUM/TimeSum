...
class DatewiseTimelineGenerator():
    ...
    def predict(self,
        ...
        print('date ranking...')
        #print(type(ref_tl.get_dates()))
        ranked_dates = list(ref_tl.get_dates())
        #list(ref_tl.get_dates())
        #list(ref_tl.get_dates())self.date_ranker.rank_dates(collection)
        #print(ranked_dates)
...
class PM_All_SentenceCollector:
    def __init__(self, clip_sents=5, pub_end=5):
        self.clip_sents = clip_sents
        self.pub_end = pub_end
